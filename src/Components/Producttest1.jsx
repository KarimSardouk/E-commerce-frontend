...
import '../styles/producttest1.css'
      ...
      <div className="container">
        <div className="row">
          ...
          <div className="col-xs-5" style={{ border: '0px solid gray' }}>
            ...
            <h3 style={{ marginTop: '0px' }}>U$S 399</h3>
            ...
            {/* Botones de compra */}
            <div className="section" style={{ paddingBottom: '20px' }}>
              <button className="btn btn-success"><span style={{ marginRight: '20px' }} className="glyphicon glyphicon-shopping-cart" aria-hidden="true"></span> Agregar al carro</button>
